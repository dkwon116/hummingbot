...
FtxPerpOrderBookTrackingDictionary = Dict[Decimal, Dict[str, Dict[str, any]]]

cdef class FtxPerpActiveOrderTracker:
    def __init__(self,
                 active_asks: FtxPerpOrderBookTrackingDictionary = None,
                 active_bids: FtxPerpOrderBookTrackingDictionary = None):
        super().__init__()
    ...
    @property
    def active_asks(self) -> FtxPerpOrderBookTrackingDictionary:
        return self._active_asks

    @property
    def active_bids(self) -> FtxPerpOrderBookTrackingDictionary:
