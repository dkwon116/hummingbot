...
from hummingbot.connector.derivative.ftx_perp.ftx_perp_api_user_stream_data_source import FtxPerpAPIUserStreamDataSource
...
class FtxPerpUserStreamTracker(UserStreamTracker):
    ...
    def data_source(self) -> UserStreamTrackerDataSource:
        if not self._data_source:
            self._data_source = FtxPerpAPIUserStreamDataSource(
                ftx_perp_auth=self._ftx_perp_auth
            )
