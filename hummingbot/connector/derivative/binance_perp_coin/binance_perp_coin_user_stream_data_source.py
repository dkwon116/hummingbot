...
class BinancePerpCoinUserStreamDataSource(UserStreamTrackerDataSource):
    ...
    def __init__(self, api_key: str, domain: str = "binance_perp_coin", throttler: Optional[AsyncThrottler] = None):
        super().__init__()
