...
class BinanceCoinPerpetualUserStreamDataSource(UserStreamTrackerDataSource):
    ...
    def __init__(
        self,
        auth: BinanceCoinPerpetualAuth,
        domain: str = "binance_coin_perpetual",
    ...
    async def get_listen_key(self):
        ...
        try:
            ...
            raise IOError(
                f"Error fetching Binance Coin Perpetual user stream listen key. "
