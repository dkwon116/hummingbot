...
class BinanceCoinPerpetualOrderBookTracker(OrderBookTracker):
    ...
    def __init__(self,
        ...
        super().__init__(data_source=BinanceCoinPerpetualAPIOrderBookDataSource(trading_pairs=trading_pairs,
                                                                                domain=domain,
                                                                                throttler=throttler,
