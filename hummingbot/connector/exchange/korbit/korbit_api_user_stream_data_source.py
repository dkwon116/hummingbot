...
from hummingbot.connector.exchange.korbit import korbit_constants as CONSTANTS
...
class KorbitAPIUserStreamDataSource(UserStreamTrackerDataSource):
    ...
    async def _connected_websocket_assistant(self) -> WSAssistant:
        ...
        #     await ws.connect(ws_url=CONSTANTS.KORBIT_WS_URL)
