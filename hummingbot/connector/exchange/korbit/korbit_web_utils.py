...
import hummingbot.connector.exchange.korbit.korbit_constants as CONSTANTS
...
def public_rest_url(path_url: str, domain: str = CONSTANTS.DEFAULT_DOMAIN) -> str:
    ...
    """
    return CONSTANTS.KORBIT_BASE_URL + path_url
...
async def get_current_server_time(
    ...
    # Korbit does not provide an endpoint to get the server time
    return time.time()
