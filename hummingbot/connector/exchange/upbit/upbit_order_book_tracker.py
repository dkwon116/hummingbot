...
class UpbitOrderBookTracker(OrderBookTracker):
    ...
    def __init__(
        ...
        super().__init__(data_source=UpbitAPIOrderBookDataSource(trading_pairs=trading_pairs,
                                                                 throttler=throttler,
        ...
        self._saved_message_queues: Dict[str, Deque[UpbitOrderBookMessage]] = \
            defaultdict(lambda: deque(maxlen=1000))
        self._active_order_trackers: Dict[str, UpbitActiveOrderTracker] = defaultdict(UpbitActiveOrderTracker)
    ...
    async def _track_single_book(self, trading_pair: str):
        ...
        """
        past_diffs_window: Deque[UpbitOrderBookMessage] = deque()
        self._past_diffs_windows[trading_pair] = past_diffs_window

        message_queue: asyncio.Queue = self._tracking_message_queues[trading_pair]
        order_book: UpbitOrderBook = self._order_books[trading_pair]
        active_order_tracker: UpbitActiveOrderTracker = self._active_order_trackers[trading_pair]
        ...
        while True:
            try:
                ...
                if message.type is OrderBookMessageType.DIFF:
                    ...
                    print(f"apply diff - {message.update_id}")
                    ...
                    past_diffs: List[UpbitOrderBookMessage] = list(past_diffs_window)
