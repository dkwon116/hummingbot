...
UpbitOrderBookTrackingDictionary = Dict[Decimal, Dict[str, Dict[str, any]]]

cdef class UpbitActiveOrderTracker:
    def __init__(self,
                 active_asks: UpbitOrderBookTrackingDictionary = None,
                 active_bids: UpbitOrderBookTrackingDictionary = None):
        super().__init__()
    ...
    @property
    def active_asks(self) -> UpbitOrderBookTrackingDictionary:
        return self._active_asks

    @property
    def active_bids(self) -> UpbitOrderBookTrackingDictionary:
