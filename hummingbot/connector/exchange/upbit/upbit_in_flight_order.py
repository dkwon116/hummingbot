...
class UpbitInFlightOrder(InFlightOrderBase):
    def __init__(self,
                 client_order_id: str,
    ...
    def update_with_trade_update(self, trade_update: Dict[str, Any]) -> bool:
        ...
        self.executed_amount_base += Decimal(str(trade_update["volume"]))

        # calculate paid_fee. If increased it will add
        self.fee_paid += Decimal(str(trade_update["paid_fee"])) - self.fee_paid
        self.executed_amount_quote += (Decimal(str(trade_update["price"])) *
                                       Decimal(str(trade_update["volume"])))
