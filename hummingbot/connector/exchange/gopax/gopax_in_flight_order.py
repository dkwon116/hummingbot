...
class GopaxInFlightOrder(InFlightOrderBase):
    def __init__(self,
                 client_order_id: str,
    ...
    def is_done(self) -> bool:
        return self.last_state in {"completed", "cancelled"}
    ...
    def update_with_trade_update(self, trade_update: Dict[str, Any]) -> bool:
        ...
        self.executed_amount_base += Decimal(str(trade_update["baseAmount"]))
        ...
        self.executed_amount_quote += (Decimal(str(trade_update["price"])) *
                                       Decimal(str(trade_update["baseAmount"])))
