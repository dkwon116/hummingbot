...
from hummingbot.connector.exchange.gopax.gopax_active_order_tracker import GopaxActiveOrderTracker
...
class GopaxOrderBookTracker(OrderBookTracker):
    ...
    def __init__(
        ...
        super().__init__(data_source=GopaxAPIOrderBookDataSource(trading_pairs=trading_pairs,
                                                                 throttler=throttler,
        ...
        self._order_books: Dict[str, GopaxOrderBook] = {}
        self._saved_message_queues: Dict[str, Deque[GopaxOrderBookMessage]] = \
            defaultdict(lambda: deque(maxlen=1000))
        self._active_order_trackers: Dict[str, GopaxActiveOrderTracker] = defaultdict(GopaxActiveOrderTracker)
    ...
    async def _track_single_book(self, trading_pair: str):
        ...
        """
        past_diffs_window: Deque[GopaxOrderBookMessage] = deque()
        self._past_diffs_windows[trading_pair] = past_diffs_window

        message_queue: asyncio.Queue = self._tracking_message_queues[trading_pair]
        order_book: GopaxOrderBook = self._order_books[trading_pair]
        active_order_tracker: GopaxActiveOrderTracker = self._active_order_trackers[trading_pair]
        ...
        while True:
            try:
                message: GopaxOrderBookMessage = None
                saved_messages: Deque[GopaxOrderBookMessage] = self._saved_message_queues[trading_pair]
                ...
                if message.type is OrderBookMessageType.DIFF:
                    ...
                    past_diffs: List[GopaxOrderBookMessage] = list(past_diffs_window)
