...
GopaxOrderBookTrackingDictionary = Dict[Decimal, Dict[str, Dict[str, any]]]

cdef class GopaxActiveOrderTracker:
    def __init__(self,
                 active_asks: GopaxOrderBookTrackingDictionary = None,
                 active_bids: GopaxOrderBookTrackingDictionary = None):
        super().__init__()
    ...
    @property
    def active_asks(self) -> GopaxOrderBookTrackingDictionary:
        return self._active_asks

    @property
    def active_bids(self) -> GopaxOrderBookTrackingDictionary:
