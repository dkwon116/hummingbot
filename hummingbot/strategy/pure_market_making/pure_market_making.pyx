...
cdef class PureMarketMakingStrategy(StrategyBase):
    ...
    cdef tuple c_get_adjusted_available_balance(self, list orders):
        ...
        cdef:
            ExchangeBase market = self._market_info.market
            object base_balance = market.c_get_available_balance(self.base_asset) * Decimal("0.995")
            object quote_balance = market.c_get_available_balance(self.quote_asset) * Decimal("0.995")
